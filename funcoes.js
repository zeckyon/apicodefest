...
1. Escreva as funções explicadas abaixo:
    ...
    function meuNome() {
        return alert("Eu sou Rodrigo, tenho 25 anos, moro em São Leopoldo e sou estudante.")
    }
    ...
    informacoes(prompt("Digite seu nome:"), parseInt(prompt("Digite sua idade:")), prompt("Digite a cidade que mora:"), prompt("Digite sua profissão:"))
